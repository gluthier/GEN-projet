...
\begin{document}
	...
	Nous utilisons également par moment certaines classes et fonctionalités provenant de la bibliothèque \href{https://github.com/google/guava}{Guava}, notamment au niveau du hashage de mot de passe et l'utilisation de tableau associatif.
