...
\begin{table}[ht]
	\begin{tabularx}{\textwidth}{|X|X|X|}
		...
		\hline
		\lstinline{\{"command":"login", "param":\{"user":"toto", "password":"hash(1234)"\}\}} & Vérification du hash de mot de passe & \lstinline{\{"token":"as73dhadc&7"\}} (réussite) ou \lstinline{\{"token":null\}} (échec) \\
		\hline
