...
\thispagestyle{empty}
	...
	\section{Cas d'utilisation}
		\subsection{Acteurs}
		\begin{itemize}
			\item Joueurs, dans une partie nommés : joueur 1 et joueur 2
			\item Administrateur
		\end{itemize}
		\subsection{Scénario principal (succès)}
		\begin{enumerate}
			\item Un des deux joueurs se connecte au lobby et crée une partie.
			...
			\end{enumerate}
			\item À la fin de la partie, soit les rôles s'inversent et on recommence à l'étape 4 soit les joueurs quittent la partie, la partie est donc interrompue et les joueurs retournent au lobby.
		\end{enumerate}
